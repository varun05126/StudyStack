...
urlpatterns = [
    ...
    # ---------- CODECHEF ----------
    path("codechef/add/", views.add_codechef, name="add_codechef"),
    path("codechef/sync/", views.codechef_sync, name="codechef_sync"),
    path("codechef/disconnect/", views.disconnect_codechef, name="disconnect_codechef"),
